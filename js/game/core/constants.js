...
export const SPIKE_SPEED = 500; // pixels per second
export const FIRE_SPEED = 500; // pixels per second
export const SPIN_SPEED = 30; // radians per second
export const MAX_AMMO = 8;
export const RELOAD_TIME = 1000; // milliseconds
export const BASE_FIRE_RATE = 1000; // milliseconds
